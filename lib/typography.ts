...
export const type = {
  ...
  display: "font-display text-[1.625rem] font-bold leading-[1.12] tracking-[-0.02em] text-foreground sm:text-[1.875rem]",
  ...
  eyebrow:
    "text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-primary/90",
  /** Default body */
...
export function typeCn(
  base: keyof typeof type,
  className?: string
): string {
