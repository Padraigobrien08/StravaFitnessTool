      ...
      <div className="flex flex-wrap gap-2">
        {prompts.map((p) => (
          <Link
            key={p.href}
            href={p.href}
            className="inline-flex items-center gap-1.5 rounded-lg border border-white/[0.08] bg-white/[0.03] px-3 py-2 text-[13px] text-zinc-300 transition-colors hover:border-accent/25 hover:bg-accent/[0.06] hover:text-accent/90"
          >
