...
Strava answers *what happened*. StrideIQ should answer **why it happened, what it means for you specifically, and what historically works for your body** — with evidence, confidence, and limits stated every time.
...
|---|------------|------|---------------------|
| 1 | Conversational training intelligence | **A** | Follow-up reasoning over *your* history beats static dashboards |
...
| 8 | Adaptive planning from adaptation profile | **A** | Plans from *your* response history — huge if real |
...
| 11 | Explainability layer | **A** (trust) | Moat via *consistency* — every surface answers “why?” |
...
**Coach system prompt upgrade:** “You are an endurance reasoning system. Use comparison and attribution tools before explaining *why*. State confidence and missing data.”
...
*Canonical differentiation reference. Update when shipping P1+ reasoning primitives.*
