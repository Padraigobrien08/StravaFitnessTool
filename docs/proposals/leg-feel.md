...
**Status:** P1–P4 shipped; outcome ladder = execution grade → HR drift → efficiency → training-response (`feat/leg-feel-more-signals`) · **Remaining:** validate weights on production data · **Risk:** low–medium
