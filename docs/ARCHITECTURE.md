...
**Core:** `get_coach_brief`, `get_readiness`, `get_predictions`, `get_week_plan`, `recommend_today_session`, `get_goal_scenarios`, `get_recommendation_outcomes`, `get_risk_patterns`, `get_race_strategy`, `get_fatigue_load`, `list_recent_runs`, `get_data_quality`, `get_connection_status`
