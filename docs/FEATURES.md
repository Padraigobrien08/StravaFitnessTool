...
`lib/driver-attribution/` — likely drivers for readiness, fatigue, forecast, efficiency,
...
| Adaptive stack                             | `lib/athlete-memory/__tests__/`, `lib/adaptation-engine/__tests__/`, `lib/driver-attribution/__tests__/` |
